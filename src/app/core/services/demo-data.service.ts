...
import { Booking, DashboardSummary, DeliveryZone, GalleryItem, LiveStream, PrasadProduct, PujaEvent, SiteContent, VideoItem } from '../models/models';
import { DASHBOARD, DELIVERY_ZONES, DEMO_BOOKINGS, GALLERY_ITEMS, LIVE_STREAM, PRASAD_PRODUCTS, PUJA_EVENTS, SITE_CONTENT, VIDEO_ITEMS } from '../../mock-data/demo.mock';
